...
output "this_eip_id" {
  ...
  value       = module.associate-with-nat.this_eip_id
}
...
output "this_eip_instance_charge_type" {
  ...
  value       = module.associate-with-nat.this_eip_instance_charge_type
}

output "this_eip_bandwidth" {
  description = "The elastic public network bandwidth."
  value       = module.associate-with-nat.this_eip_bandwidth
}
...
output "this_eip_status" {
  ...
  value       = module.associate-with-nat.this_eip_status
}
...
output "this_eip_tags" {
  ...
  value       = module.associate-with-nat.this_eip_tags
}

output "this_eip_resource_group_id" {
  description = "The EIP belongs to this resource_group_id. "
  value       = module.associate-with-nat.this_eip_resource_group_id
}

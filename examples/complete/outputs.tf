...
output "this_eip_association_id" {
  ...
  value       = module.example.this_eip_association_id
}
...
output "this_eip_association_instance_type" {
  ...
  value       = module.example.this_eip_association_instance_type
}
...
variable "instance_tags" {
  description = "Query ECS instances based on tags."
  type        = map(string)
  default     = {}
}

variable "instance_resource_group_id" {
  description = "Query ECS instance based on resource_group_id."
  type        = string
  default     = ""
}

variable "name_regex" {
  description = "Query ECS instance based on name_regex."
  type        = string
  default     = ""
}

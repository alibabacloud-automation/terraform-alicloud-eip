...
output "this_eip_association_id" {
  ...
  value       = module.eip-nat.this_eip_association_id
}

output "this_eip_association_instance_id" {
  description = "The NAT instance ID associated with the EIP."
  value       = module.eip-nat.this_eip_association_instance_id
}

output "this_eip_association_instance_type" {
  description = "The type of cloud product that the eip instance to bind."
  value       = module.eip-nat.this_eip_association_instance_type
}
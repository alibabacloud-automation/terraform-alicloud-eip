...
variable "name" {
  ...
  type        = string
  default     = "TF-EIP-For-ECS-Instance"
}
...
variable "description" {
  ...
  type        = string
  default     = "An EIP associated with SLB instance."
}
...
variable "instance_tags" {
  description = "Query SLB instances based on tags."
  type        = map(string)
  default     = {}
}

variable "instance_resource_group_id" {
  description = "Query SLB instance based on resource_group_id."
  type        = string
  default     = ""
}

variable "name_regex" {
  description = "Query SLB instance based on name_regex."
  type        = string
  default     = ""
}
...
variable "computed_instances" {
  description = "List of SLB instances created by calling alicloud_slb."
  type = list(object({
    instance_type = string
    instance_ids  = list(string)
    private_ips   = list(string)
